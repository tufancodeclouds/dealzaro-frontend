  ...
  return (
    <div>
      ...
      <div className="my-10 flex flex-col md:flex-row gap-16">
        <img className="w-full md:max-w-[450px]" src={assets.about_img} alt="About Dealzaro" />
        <div className="flex flex-col justify-center gap-6 md:w-2/4 text-gray-600">
          <p>
            Dealzaro was born out of a passion for innovation and a desire to revolutionize the way people shop
          ...
          <p>
            Our mission at Dealzaro is to empower customers with choice, convenience, and confidence. We're dedicated
