    ...
    <div className="pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 pt-6 text-sm text-gray-500">
          <p>
            Dealzaro is a modern e-commerce platform dedicated to making fashion accessible and
            convenient...
          </p>
          <p>
            At Dealzaro, each product page offers detailed descriptions, high-quality images...
          </p>
        </div>
      </div>
